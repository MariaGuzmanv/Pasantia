var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Administration;
    ...
    })(Administration = Tienda_Deportiva.Administration || (Tienda_Deportiva.Administration = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Administration;
    (function (Administration) {
...
(function (Tienda_Deportiva) {
    ...
    })(BasicSamples = Tienda_Deportiva.BasicSamples || (Tienda_Deportiva.BasicSamples = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Tienda_Deportiva.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Tienda_Deportiva.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Tienda_Deportiva.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Tienda_Deportiva) {
    ...
    })(Common = Tienda_Deportiva.Common || (Tienda_Deportiva.Common = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Common;
...
(function (Tienda_Deportiva) {
    ...
    })(Membership = Tienda_Deportiva.Membership || (Tienda_Deportiva.Membership = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Membership;
...
(function (Tienda_Deportiva) {
    ...
    })(Northwind = Tienda_Deportiva.Northwind || (Tienda_Deportiva.Northwind = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Northwind;
...
(function (Tienda_Deportiva) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Tienda_Deportiva.Northwind.Gender', 'Tienda_Deportiva.Northwind.Entities.Gender');
    })(Northwind = Tienda_Deportiva.Northwind || (Tienda_Deportiva.Northwind = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
...
(function (Tienda_Deportiva) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'Tienda_Deportiva.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = Tienda_Deportiva.Northwind || (Tienda_Deportiva.Northwind = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
...
(function (Tienda_Deportiva) {
    ...
    })(Authorization = Tienda_Deportiva.Authorization || (Tienda_Deportiva.Authorization = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Administration;
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Tienda_Deportiva.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Tienda_Deportiva.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Tienda_Deportiva.Common.ReportHelper.execute({
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Tienda_Deportiva.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Tienda_Deportiva.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Tienda_Deportiva.Northwind.OrderDialog();
                        ...
                        var chai = Tienda_Deportiva.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Tienda_Deportiva.Northwind.EmployeeRow.getLookup().items
        ...
        }(Tienda_Deportiva.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Tienda_Deportiva.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.OrderDialog));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Tienda_Deportiva.Northwind.CategoryService.Retrieve({
        ...
        }(Tienda_Deportiva.Northwind.CategoryDialog));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Tienda_Deportiva.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Tienda_Deportiva.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Tienda_Deportiva.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Tienda_Deportiva.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Tienda_Deportiva.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Tienda_Deportiva.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Tienda_Deportiva.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Tienda_Deportiva.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Tienda_Deportiva.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return Tienda_Deportiva.LanguageList.getValue();
            };
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.SupplierDialog));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Tienda_Deportiva.Northwind.SupplierGrid));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Tienda_Deportiva.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Tienda_Deportiva.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Tienda_Deportiva.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Tienda_Deportiva.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Tienda_Deportiva.Northwind.CustomerDialog));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.CustomerGrid));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Tienda_Deportiva.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(Tienda_Deportiva.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Tienda_Deportiva.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Tienda_Deportiva.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Tienda_Deportiva.Northwind.OrderDetailDialog));
...
(function (Tienda_Deportiva) {
    ...
    (function (Northwind) {
        ...
        }(Tienda_Deportiva.Common.GridEditorBase));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Northwind.OrderDetailsEditor));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Tienda_Deportiva.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Tienda_Deportiva.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Tienda_Deportiva.BasicProgressDialog();
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        ...
        }(Tienda_Deportiva.Common.BulkServiceAction));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Tienda_Deportiva.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Tienda_Deportiva.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Tienda_Deportiva.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Tienda_Deportiva.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Tienda_Deportiva.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Tienda_Deportiva.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Tienda_Deportiva) {
    ...
    Tienda_Deportiva.SelectableEntityGrid = SelectableEntityGrid;
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Tienda_Deportiva.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Tienda_Deportiva.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Tienda_Deportiva.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Tienda_Deportiva.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Tienda_Deportiva.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Tienda_Deportiva.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Tienda_Deportiva.Northwind.ProductService.baseUrl; };
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Tienda_Deportiva.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Tienda_Deportiva.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Tienda_Deportiva.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Tienda_Deportiva.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Tienda_Deportiva) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Tienda_Deportiva.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Tienda_Deportiva.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Tienda_Deportiva.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Tienda_Deportiva) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Tienda_Deportiva.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Tienda_Deportiva.LanguageList || (Tienda_Deportiva.LanguageList = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
...
(function (Tienda_Deportiva) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Tienda_Deportiva.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Tienda_Deportiva.ScriptInitialization || (Tienda_Deportiva.ScriptInitialization = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    ...
    Tienda_Deportiva.BasicProgressDialog = BasicProgressDialog;
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var DialogUtils;
    ...
    })(DialogUtils = Tienda_Deportiva.DialogUtils || (Tienda_Deportiva.DialogUtils = {}));
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Common;
...
(function (Tienda_Deportiva) {
    ...
    Tienda_Deportiva.StaticTextBlock = StaticTextBlock;
})(Tienda_Deportiva || (Tienda_Deportiva = {}));
var Tienda_Deportiva;
(function (Tienda_Deportiva) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Tienda_Deportiva.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=Tienda_Deportiva.Web.js.map